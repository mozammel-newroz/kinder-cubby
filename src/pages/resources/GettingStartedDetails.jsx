        ...
        <Grid item lg={12}>
          <div className={classes.find_banner2}>
            <div className={classes.margin_bottom10}>
              ...
              >
                <Link color="inherit" to="/documentation" onClick={handleClick}>
                  <Typography className={classes.breadcrumbs_title_style}>
                    All Topics
                  </Typography>
                </Link>

                <Link color="inherit" to="/getting-started">
                  <Typography className={`${classes.breadcrumbs_title_style}`}>
                    Getting Started
                  </Typography>
                </Link>
            ...
            <div className={classes.background_style}>
              <div className={classes.card}>
                ...
                <div className={classes.margin_tom40}>
                  <Typography variant="body1">
                    Quisque suscipit ipsum est, eu venenatis leo ornare eget. Ut
                    porta facilisis elementum. Sed condimentum sed massa quis
                    ullamcorper. Donec at scelerisque neque. Pellentesque
                    ...
                    fermentum aliquet quam euismod non. Proin cursus, libero
                    quis semper elementum, diam metus eleifend magna, in
                    placerat sem velit vitae lacus. Vivamus tempor fringilla
                    nisl, id condimentum felis dignissim nec.
                  </Typography>
                </div>
                <div className={classes.margin_tom40}>
                  <Typography variant="body1">
